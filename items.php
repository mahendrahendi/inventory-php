...
?>
					<tr data-type="element" data-id="<?php echo $item->id; ?>">
						...
						<td class="hover" data-type="id"><?php echo $item->descrp; ?></td>
						...
						<td><a href="<?php echo $image; ?>"><img src="<?php echo $image; ?>" width="50" height="50" title="Click to full size" alt=""></a></td>  
					<!--	<td><?php echo $_items->parse_price($item->descrp); ?></td> -->
						<td>
